  ...
  return <div className="journey" id="top">
    ...
    <main className="journey-scroll">
      <section id="field" className="chapter chapter--field" aria-labelledby="field-title">
        <div className="chapter-hero-copy"><p className="eyebrow"><span />00 / FIELD</p><h1 id="field-title">Systems that hold<br /><i>when the real world moves.</i></h1><p>Field work taught me to notice dependencies, handoffs, and consequences. I carry that discipline into products people can inspect, use, and change.</p><a className="button button--acid" href="#field-record">Follow the record <ArrowDown size={16} /></a></div>
      ...
      <section id="rome" className="chapter chapter--rome" aria-labelledby="rome-title">
        ...
        <div className="rome-copy"><p className="eyebrow"><span />02 / ROME</p><h2 id="rome-title">A different frame.<br /><i>Still the same record.</i></h2><p>Real Italian architecture and personal travel imagery create a memory-space with depth, rather than a mood board or an invented travel scene.</p></div>
        <div className="rome-frames"><figure><img src="/media/travel/rome-personal-bench.jpg" alt="Personal travel moment in Italy" loading="lazy" /><figcaption>Italy / personal record</figcaption></figure><figure><img src="/media/travel/rome-plate-02.jpg" alt="Italian street transition" loading="lazy" /><figcaption>Italy / transition</figcaption></figure><figure><img src="/media/travel/rome-plate-03.jpg" alt="Italian architecture" loading="lazy" /><figcaption>Italy / architecture</figcaption></figure></div>
      </section>

      <section id="studio" className="chapter chapter--studio" aria-labelledby="studio-title"><div><p className="eyebrow"><span />03 / STUDIO</p><h2 id="studio-title">The same instinct,<br /><i>applied to software.</i></h2><p>Useful AI work needs a system that remembers why a change was made, what it depends on, and whether the result can actually be checked.</p><a className="text-link" href="#work">Enter selected work <ArrowRight size={15} /></a></div><figure className="studio-capture"><img src="/media/game-studio/studio-surface.jpg" alt="Game Studio creator interface from a real local capture" loading="lazy" /><figcaption><span>Game Studio</span><span>Real local capture</span></figcaption></figure></section>
